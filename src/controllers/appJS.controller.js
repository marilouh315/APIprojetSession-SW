...
exports.afficherToutesTaches = (req, res) => {
    ...
    appJSModel.afficherToutesTachesallo(cleApi)
...
exports.afficherTachesParDefaut = (req, res) => {
    const cleApi = req.headers.authorization;
    appJSModel.afficherTachesParDefaut(cleApi)
    .then((taches_resultat) => {
        if (!taches_resultat) {
            res.status(404).json;
            res.send({
        ...
        if (idExiste == false) {
            ...
            .then((cleValide) => {
                if (!cleValide) {
                    ...
                    appJSModel.modifierStatutTache(complete_tache, id_tache, cleApi)
        ...
        if (idExiste == false) {
            ...
            .then((cleValide) => {
                if (!cleValide) {
                    ...
                    appJSModel.supprimerTache(id_tache, cleApi)
